...
public class updatemedicine extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SELECT MEDICINE YOU WANT TO ADD TO UPDATE QUANTITY");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(7, 43, 380, 15);
        ...
        selector.setBounds(10, 110, 160, 32);

        quantity.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(quantity);
        quantity.setBounds(210, 110, 163, 29);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("QUANTITY");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(240, 80, 110, 22);
        ...
        jLabel4.setBounds(30, 230, 350, 20);
        ...
        jLabel6.setBounds(-370, -180, 940, 560);
...
public int getmedicine(String medname){
    ...
    try{
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/pceaturidispensary" , "root", "");
            String sql =  "update into medicinestore (name,quantity) values (?,?)";
            PreparedStatement stmt = conn.prepareStatement(sql);
       ...
       JOptionPane.showMessageDialog(null, "Medicine updated", "success", JOptionPane.INFORMATION_MESSAGE);
